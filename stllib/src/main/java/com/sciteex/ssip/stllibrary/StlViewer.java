package com.sciteex.ssip.stllibrary;
...
public class StlViewer extends View{

	private Integer rawResource;
	private InputStream stlStream;
	private String pathFile;

	public StlViewer(Context context, int rawResource) {
		super(context);
		this.rawResource = rawResource;
	}

	public StlViewer(Context context, String pathFile) {
		super(context);
		this.pathFile = pathFile;
	}

	public StlViewer(Context context, InputStream stlStream)
	{
		super(context);
	...
	private InputStream getInputStreamFile(){
		...
		//If stl stream is declared, return it.
		//if(stlStream != null)
			return stlStream;
		/*
        InputStream is = null;
